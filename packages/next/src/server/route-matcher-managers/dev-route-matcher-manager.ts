...
export class DevRouteMatcherManager extends DefaultRouteMatcherManager {
  ...
  public async *matchAll(
    ...
    let matchDevelopmentRouteSpan = shouldTraceDetailedMatch
      ...
      : undefined
    matchDevelopmentRouteSpan?.updateName('match development route')
      ...
      for await (const developmentMatch of super.matchAll(pathname, options)) {
        ...
        if (shouldTraceDetailedMatch) {
          await getTracer().trace(
            ...
            { spanName: 'compile and prepare route' },
        ...
        let matchProductionRouteSpan = shouldTraceDetailedMatch
          ...
          : undefined
        matchProductionRouteSpan?.updateName('match production route')
